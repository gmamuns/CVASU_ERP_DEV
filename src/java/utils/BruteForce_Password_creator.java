 ...
 * @author mamuns
 */
public class BruteForce_Password_creator {
    ...
    public BruteForce_Password_creator(String pPropertyFileName, String pUserPasswordKey, String pIsPasswordEncryptedKey) throws Exception {
